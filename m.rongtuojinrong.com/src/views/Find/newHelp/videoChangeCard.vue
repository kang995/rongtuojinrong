 ...
 components: {
    ...
    data(){
        return{
            data:[],//详情数据
            num:[],//点赞数据
            fileUrl:'https://php.rongtuojinrong.com/Uploads/2017/video/genghuanyinhangkaer.mp4',// 资源的url路径地址
            fileImg:'',// 资源的图片路径地址
            // playerOptions: {
            ...
            //     sources: [{
            //         type: "video/mp4",
            //         src:'https://php.rongtuojinrong.com/Uploads/2017/video/genghuanyinhangkaer.mp4',
            //     },{
    ...
    filters: {
        formatDate(time) {
            ...
            return formatDate(date, "y-MM-dd hh:mm");
        },
        formatDate2(time) {
            var date = new Date(time * 1000);
