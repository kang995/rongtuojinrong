<template>
    <div class="redenvelopeBox">
        <div class="redenvelopeBox-1">
            ...
            <router-link :to="{name:'addinterestUse'}" class="redenvelopeBox-1s" tag="span">使用说明</router-link>
        </div>

        <div v-if="znum==0" class="redenvelopeBox-3">
            <div class="redenvelopeBox-3-a">暂无加息券</div>
            <router-link :to="{name:'usedAddinterest'}" tag="div">查看已使用和过期加息券 ></router-link>
        </div>
